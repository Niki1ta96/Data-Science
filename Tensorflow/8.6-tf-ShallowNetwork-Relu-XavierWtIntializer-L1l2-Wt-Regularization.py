...
def model_function(features, targets, mode):
    # 1st hidden layer
    hlayer = layers.stack(features, layers.fully_connected,[1000,100,50,20],
                          activation_fn = tf.nn.relu,
                          weights_regularizer=layers.l1_l2_regularizer(1.0,2.0),
                          weights_initializer=layers.xavier_initializer(uniform=True,seed=196))# 98.49% on test
...
classifier = learn.Estimator(model_fn=model_function, model_dir="//home//tensorflow//Models//Shallow-NN-Model//Model6")    
